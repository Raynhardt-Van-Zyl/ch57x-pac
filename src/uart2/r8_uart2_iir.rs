#[doc = "Register `R8_UART2_IIR` reader"]
pub type R = crate::R<R8Uart2IirSpec>;
...
pub type RbIirFifoIdR = crate::BitReader;
impl R {
    ...
    pub fn rb_iir_fifo_id(&self) -> RbIirFifoIdR {
        RbIirFifoIdR::new(((self.bits >> 7) & 1) != 0)
    }
}
#[doc = "RO, UART2 interrupt identification\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart2_iir::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Uart2IirSpec;
impl crate::RegisterSpec for R8Uart2IirSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_uart2_iir::R`](R) reader structure"]
impl crate::Readable for R8Uart2IirSpec {}
#[doc = "`reset()` method sets R8_UART2_IIR to value 0x01"]
impl crate::Resettable for R8Uart2IirSpec {
