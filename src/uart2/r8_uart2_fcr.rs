...
pub type R = crate::R<R8Uart2FcrSpec>;
#[doc = "Register `R8_UART2_FCR` writer"]
pub type W = crate::W<R8Uart2FcrSpec>;
...
impl W {
    #[doc = "Bit 0 - RW, UART FIFO enable"]
    #[inline(always)]
    pub fn rb_fcr_fifo_en(&mut self) -> RbFcrFifoEnW<'_, R8Uart2FcrSpec> {
        RbFcrFifoEnW::new(self, 0)
    }
    #[doc = "Bit 1 - WZ, clear UART receiver FIFO, high action, auto clear"]
    #[inline(always)]
    pub fn rb_fcr_rx_fifo_clr(&mut self) -> RbFcrRxFifoClrW<'_, R8Uart2FcrSpec> {
        RbFcrRxFifoClrW::new(self, 1)
    }
    #[doc = "Bit 2 - WZ, clear UART transmitter FIFO, high action, auto clear"]
    #[inline(always)]
    pub fn rb_fcr_tx_fifo_clr(&mut self) -> RbFcrTxFifoClrW<'_, R8Uart2FcrSpec> {
        RbFcrTxFifoClrW::new(self, 2)
    }
    #[doc = "Bits 6:7 - RW, UART receiver FIFO trigger level: 00-1byte, 01-2bytes, 10-4bytes, 11-7bytes"]
    #[inline(always)]
    pub fn rb_fcr_fifo_trig(&mut self) -> RbFcrFifoTrigW<'_, R8Uart2FcrSpec> {
        RbFcrFifoTrigW::new(self, 6)
    }
}
#[doc = "RW, UART2 FIFO control\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart2_fcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_uart2_fcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Uart2FcrSpec;
impl crate::RegisterSpec for R8Uart2FcrSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_uart2_fcr::R`](R) reader structure"]
impl crate::Readable for R8Uart2FcrSpec {}
#[doc = "`write(|w| ..)` method takes [`r8_uart2_fcr::W`](W) writer structure"]
impl crate::Writable for R8Uart2FcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets R8_UART2_FCR to value 0"]
impl crate::Resettable for R8Uart2FcrSpec {}
