#[doc = "Register `R8_TMR1_INTER_EN` reader"]
pub type R = crate::R<R8Tmr1InterEnSpec>;
#[doc = "Register `R8_TMR1_INTER_EN` writer"]
pub type W = crate::W<R8Tmr1InterEnSpec>;
...
impl W {
    #[doc = "Bit 0 - RW, enable interrupt for timer capture count timeout or PWM cycle end"]
    #[inline(always)]
    pub fn rb_tmr_ie_cyc_end(&mut self) -> RbTmrIeCycEndW<'_, R8Tmr1InterEnSpec> {
        RbTmrIeCycEndW::new(self, 0)
    }
    #[doc = "Bit 1 - RW, enable interrupt for timer capture input action or PWM trigger"]
    #[inline(always)]
    pub fn rb_tmr_ie_data_act(&mut self) -> RbTmrIeDataActW<'_, R8Tmr1InterEnSpec> {
        RbTmrIeDataActW::new(self, 1)
    }
    #[doc = "Bit 2 - RW, enable interrupt for timer FIFO half (capture fifo >=4 or PWM fifo less than 3)"]
    #[inline(always)]
    pub fn rb_tmr_ie_fifo_hf(&mut self) -> RbTmrIeFifoHfW<'_, R8Tmr1InterEnSpec> {
        RbTmrIeFifoHfW::new(self, 2)
    }
    #[doc = "Bit 3 - RW, enable interrupt for timer1/2 DMA completion"]
    #[inline(always)]
    pub fn rb_tmr_ie_dma_end(&mut self) -> RbTmrIeDmaEndW<'_, R8Tmr1InterEnSpec> {
        RbTmrIeDmaEndW::new(self, 3)
    }
    #[doc = "Bit 4 - RW, enable interrupt for timer FIFO overflow"]
    #[inline(always)]
    pub fn rb_tmr_ie_fifo_ov(&mut self) -> RbTmrIeFifoOvW<'_, R8Tmr1InterEnSpec> {
        RbTmrIeFifoOvW::new(self, 4)
    }
}
#[doc = "RW, TMR1 interrupt enable\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_tmr1_inter_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_tmr1_inter_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Tmr1InterEnSpec;
impl crate::RegisterSpec for R8Tmr1InterEnSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_tmr1_inter_en::R`](R) reader structure"]
impl crate::Readable for R8Tmr1InterEnSpec {}
#[doc = "`write(|w| ..)` method takes [`r8_tmr1_inter_en::W`](W) writer structure"]
impl crate::Writable for R8Tmr1InterEnSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets R8_TMR1_INTER_EN to value 0"]
impl crate::Resettable for R8Tmr1InterEnSpec {}
