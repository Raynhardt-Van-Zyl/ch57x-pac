#[doc = "Register `R8_UART0_LSR` reader"]
pub type R = crate::R<R8Uart0LsrSpec>;
...
#[doc = "RO, UART0 line status\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart0_lsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Uart0LsrSpec;
impl crate::RegisterSpec for R8Uart0LsrSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_uart0_lsr::R`](R) reader structure"]
impl crate::Readable for R8Uart0LsrSpec {}
#[doc = "`reset()` method sets R8_UART0_LSR to value 0x60"]
impl crate::Resettable for R8Uart0LsrSpec {
