...
pub type R = crate::R<R8Uart0LcrSpec>;
#[doc = "Register `R8_UART0_LCR` writer"]
pub type W = crate::W<R8Uart0LcrSpec>;
...
impl W {
    #[doc = "Bits 0:1 - RW, UART word bit length: 00-5bit, 01-6bit, 10-7bit, 11-8bit"]
    #[inline(always)]
    pub fn rb_lcr_word_sz(&mut self) -> RbLcrWordSzW<'_, R8Uart0LcrSpec> {
        RbLcrWordSzW::new(self, 0)
    }
    #[doc = "Bit 2 - RW, UART stop bit length: 0-1bit, 1-2bit"]
    #[inline(always)]
    pub fn rb_lcr_stop_bit(&mut self) -> RbLcrStopBitW<'_, R8Uart0LcrSpec> {
        RbLcrStopBitW::new(self, 2)
    }
    #[doc = "Bit 3 - RW, UART parity enable"]
    #[inline(always)]
    pub fn rb_lcr_par_en(&mut self) -> RbLcrParEnW<'_, R8Uart0LcrSpec> {
        RbLcrParEnW::new(self, 3)
    }
    #[doc = "Bits 4:5 - RW, UART parity mode: 00-odd, 01-even, 10-mark, 11-space"]
    #[inline(always)]
    pub fn rb_lcr_par_mod(&mut self) -> RbLcrParModW<'_, R8Uart0LcrSpec> {
        RbLcrParModW::new(self, 4)
    }
    #[doc = "Bit 6 - RW, UART break control enable"]
    #[inline(always)]
    pub fn rb_lcr_break_en(&mut self) -> RbLcrBreakEnW<'_, R8Uart0LcrSpec> {
        RbLcrBreakEnW::new(self, 6)
    }
    #[doc = "Bit 7 - RW, UART general purpose bit;RW, UART reserved bit"]
    #[inline(always)]
    pub fn rb_lcr_gp_bit__rb_lcr_dlab(&mut self) -> RbLcrGpBit_RbLcrDlabW<'_, R8Uart0LcrSpec> {
        RbLcrGpBit_RbLcrDlabW::new(self, 7)
    }
}
#[doc = "RW, UART0 line control\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart0_lcr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_uart0_lcr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Uart0LcrSpec;
impl crate::RegisterSpec for R8Uart0LcrSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_uart0_lcr::R`](R) reader structure"]
impl crate::Readable for R8Uart0LcrSpec {}
#[doc = "`write(|w| ..)` method takes [`r8_uart0_lcr::W`](W) writer structure"]
impl crate::Writable for R8Uart0LcrSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets R8_UART0_LCR to value 0"]
impl crate::Resettable for R8Uart0LcrSpec {}
