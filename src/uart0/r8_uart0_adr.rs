...
#[doc = "Field `R8_UART0_ADR` reader - RW,UART0 slave address: 0xFF=disable, other=enable"]
pub type R8Uart0AdrR = crate::FieldReader;
#[doc = "Field `R8_UART0_ADR` writer - RW,UART0 slave address: 0xFF=disable, other=enable"]
