...
#[doc = "Field `RB_MSR_CTS_CHG` reader - RZ, UART0 CTS changed status, high action"]
pub type RbMsrCtsChgR = crate::BitReader;
#[doc = "Field `RB_MSR_DSR_CHG` reader - RZ, UART0 DSR changed status, high action"]
pub type RbMsrDsrChgR = crate::BitReader;
#[doc = "Field `RB_MSR_RI_CHG` reader - RZ, UART0 RI changed status, high action"]
pub type RbMsrRiChgR = crate::BitReader;
#[doc = "Field `RB_MSR_DCD_CHG` reader - RZ, UART0 DCD changed status, high action"]
pub type RbMsrDcdChgR = crate::BitReader;
#[doc = "Field `RB_MSR_CTS` reader - RO, UART0 CTS action status"]
pub type RbMsrCtsR = crate::BitReader;
#[doc = "Field `RB_MSR_DSR` reader - RO, UART0 DSR action statusv"]
pub type RbMsrDsrR = crate::BitReader;
#[doc = "Field `RB_MSR_RI` reader - RO, UART0 RI action status"]
pub type RbMsrRiR = crate::BitReader;
#[doc = "Field `RB_MSR_DCD` reader - RO, UART0 DCD action status"]
