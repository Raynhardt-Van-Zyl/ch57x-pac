#[doc = "Register `R8_TMR0_CTRL_MOD` reader"]
pub type R = crate::R<R8Tmr0CtrlModSpec>;
#[doc = "Register `R8_TMR0_CTRL_MOD` writer"]
pub type W = crate::W<R8Tmr0CtrlModSpec>;
...
impl W {
    #[doc = "Bit 0 - RW, timer in mode: 0=timer/PWM, 1=capture/count"]
    #[inline(always)]
    pub fn rb_tmr_mode_in(&mut self) -> RbTmrModeInW<'_, R8Tmr0CtrlModSpec> {
        RbTmrModeInW::new(self, 0)
    }
    #[doc = "Bit 1 - RW, force clear timer FIFO and count"]
    #[inline(always)]
    pub fn rb_tmr_all_clear(&mut self) -> RbTmrAllClearW<'_, R8Tmr0CtrlModSpec> {
        RbTmrAllClearW::new(self, 1)
    }
    #[doc = "Bit 2 - RW, timer count enable"]
    #[inline(always)]
    pub fn rb_tmr_count_en(&mut self) -> RbTmrCountEnW<'_, R8Tmr0CtrlModSpec> {
        RbTmrCountEnW::new(self, 2)
    }
    #[doc = "Bit 3 - RW, timer output enable"]
    #[inline(always)]
    pub fn rb_tmr_out_en(&mut self) -> RbTmrOutEnW<'_, R8Tmr0CtrlModSpec> {
    ...
    pub fn rb_tmr_out_polar__rb_tmr_cap_count(
        &mut self,
    ) -> RbTmrOutPolar_RbTmrCapCountW<'_, R8Tmr0CtrlModSpec> {
    ...
    pub fn rb_tmr_pwm_repeat__rb_tmr_cap_edge(
        &mut self,
    ) -> RbTmrPwmRepeat_RbTmrCapEdgeW<'_, R8Tmr0CtrlModSpec> {
        RbTmrPwmRepeat_RbTmrCapEdgeW::new(self, 6)
    }
}
#[doc = "RW, TMR0 mode control\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_tmr0_ctrl_mod::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_tmr0_ctrl_mod::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Tmr0CtrlModSpec;
impl crate::RegisterSpec for R8Tmr0CtrlModSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_tmr0_ctrl_mod::R`](R) reader structure"]
impl crate::Readable for R8Tmr0CtrlModSpec {}
#[doc = "`write(|w| ..)` method takes [`r8_tmr0_ctrl_mod::W`](W) writer structure"]
impl crate::Writable for R8Tmr0CtrlModSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets R8_TMR0_CTRL_MOD to value 0x02"]
impl crate::Resettable for R8Tmr0CtrlModSpec {
