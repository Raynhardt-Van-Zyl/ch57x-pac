...
#[doc = "Field `R32_TMR0_CNT_END` reader - RW1,TMR0 end count value"]
pub type R32Tmr0CntEndR = crate::FieldReader<u32>;
#[doc = "Field `R32_TMR0_CNT_END` writer - RW1,TMR0 end count value"]
pub type R32Tmr0CntEndW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW1,TMR0 end count value"]
    #[inline(always)]
    pub fn r32_tmr0_cnt_end(&self) -> R32Tmr0CntEndR {
        R32Tmr0CntEndR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - RW1,TMR0 end count value"]
    #[inline(always)]
    pub fn r32_tmr0_cnt_end(&mut self) -> R32Tmr0CntEndW<'_, R32Tmr0CntEndSpec> {
        R32Tmr0CntEndW::new(self, 0)
    }
}
