...
#[doc = "Field `RB_TMR_DMA_ENABLE` reader - RW, timer1_2 DMA enable"]
pub type RbTmrDmaEnableR = crate::BitReader;
#[doc = "Field `RB_TMR_DMA_ENABLE` writer - RW, timer1_2 DMA enable"]
pub type RbTmrDmaEnableW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RB_TMR_DMA_LOOP` reader - RW, timer1_2 DMA address loop enable"]
pub type RbTmrDmaLoopR = crate::BitReader;
#[doc = "Field `RB_TMR_DMA_LOOP` writer - RW, timer1_2 DMA address loop enable"]
