...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn r8_uart0_thr(&self) -> &R8Uart0Thr {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(8).cast() }
    }
    #[doc = "0x08 - RO, UART0 receiver buffer, receiving byte"]
    #[inline(always)]
    pub const fn r8_uart0_rbr(&self) -> &R8Uart0Rbr {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(8).cast() }
    }
...
#[doc = "R8_UART0_RBR (r) register accessor: RO, UART0 receiver buffer, receiving byte\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart0_rbr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@r8_uart0_rbr`] module"]
#[doc(alias = "R8_UART0_RBR")]
pub type R8Uart0Rbr = crate::Reg<r8_uart0_rbr::R8Uart0RbrSpec>;
#[doc = "RO, UART0 receiver buffer, receiving byte"]
pub mod r8_uart0_rbr;
#[doc = "R8_UART0_THR (w) register accessor: WO, UART0 transmitter holding, transmittal byte\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_uart0_thr::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@r8_uart0_thr`] module"]
#[doc(alias = "R8_UART0_THR")]
pub type R8Uart0Thr = crate::Reg<r8_uart0_thr::R8Uart0ThrSpec>;
#[doc = "WO, UART0 transmitter holding, transmittal byte"]
pub mod r8_uart0_thr;
#[doc = "R8_UART0_RFC (r) register accessor: RO, UART0 receiver FIFO count\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart0_rfc::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@r8_uart0_rfc`] module"]
