#[doc = "Register `R8_UART1_IIR` reader"]
pub type R = crate::R<R8Uart1IirSpec>;
...
#[doc = "RO, UART1 interrupt identification\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart1_iir::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Uart1IirSpec;
impl crate::RegisterSpec for R8Uart1IirSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_uart1_iir::R`](R) reader structure"]
impl crate::Readable for R8Uart1IirSpec {}
#[doc = "`reset()` method sets R8_UART1_IIR to value 0x01"]
impl crate::Resettable for R8Uart1IirSpec {
