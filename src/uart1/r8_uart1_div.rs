...
#[doc = "Field `R8_UART1_DIV` reader - RW, UART1 pre-divisor latch byte, only low 7 bit, from 1 to 128"]
pub type R8Uart1DivR = crate::FieldReader;
#[doc = "Field `R8_UART1_DIV` writer - RW, UART1 pre-divisor latch byte, only low 7 bit, from 1 to 128"]
