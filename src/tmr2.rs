...
pub struct RegisterBlock {
    ...
    r16_tmr2_dma_now: R16Tmr2DmaNow,
    _reserved9: [u8; 0x02],
    r16_tmr2_dma_beg: R16Tmr2DmaBeg,
    _reserved10: [u8; 0x02],
    r16_tmr2_dma_end: R16Tmr2DmaEnd,
}
impl RegisterBlock {
...
#[doc = "R16_TMR2_DMA_NOW (r) register accessor: RO, TMR2 DMA current address\n\nYou can [`read`](crate::Reg::read) this register and get [`r16_tmr2_dma_now::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@r16_tmr2_dma_now`] module"]
#[doc(alias = "R16_TMR2_DMA_NOW")]
pub type R16Tmr2DmaNow = crate::Reg<r16_tmr2_dma_now::R16Tmr2DmaNowSpec>;
#[doc = "RO, TMR2 DMA current address"]
pub mod r16_tmr2_dma_now;
#[doc = "R16_TMR2_DMA_BEG (rw) register accessor: RW, TMR2 DMA begin address\n\nYou can [`read`](crate::Reg::read) this register and get [`r16_tmr2_dma_beg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r16_tmr2_dma_beg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@r16_tmr2_dma_beg`] module"]
#[doc(alias = "R16_TMR2_DMA_BEG")]
pub type R16Tmr2DmaBeg = crate::Reg<r16_tmr2_dma_beg::R16Tmr2DmaBegSpec>;
#[doc = "RW, TMR2 DMA begin address"]
pub mod r16_tmr2_dma_beg;
#[doc = "R16_TMR2_DMA_END (rw) register accessor: RW, TMR2 DMA end address\n\nYou can [`read`](crate::Reg::read) this register and get [`r16_tmr2_dma_end::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r16_tmr2_dma_end::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@r16_tmr2_dma_end`] module"]
#[doc(alias = "R16_TMR2_DMA_END")]
pub type R16Tmr2DmaEnd = crate::Reg<r16_tmr2_dma_end::R16Tmr2DmaEndSpec>;
