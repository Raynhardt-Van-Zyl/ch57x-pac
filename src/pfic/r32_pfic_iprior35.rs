...
#[doc = "Field `IPRIOR35` reader - RW,IPRIOR35"]
pub type Iprior35R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR35` writer - RW,IPRIOR35"]
pub type Iprior35W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR35"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR35"]
    #[inline(always)]
    pub fn iprior35(&mut self) -> Iprior35W<'_, R32PficIprior35Spec> {
