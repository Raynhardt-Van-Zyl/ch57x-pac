...
#[doc = "Field `IPRIOR58` reader - RW,IPRIOR58"]
pub type Iprior58R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR58` writer - RW,IPRIOR58"]
pub type Iprior58W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR58"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR58"]
    #[inline(always)]
    pub fn iprior58(&mut self) -> Iprior58W<'_, R32PficIprior58Spec> {
