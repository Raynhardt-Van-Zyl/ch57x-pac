...
#[doc = "Field `IPRIOR61` reader - RW,IPRIOR61"]
pub type Iprior61R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR61` writer - RW,IPRIOR61"]
pub type Iprior61W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR61"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR61"]
    #[inline(always)]
    pub fn iprior61(&mut self) -> Iprior61W<'_, R32PficIprior61Spec> {
