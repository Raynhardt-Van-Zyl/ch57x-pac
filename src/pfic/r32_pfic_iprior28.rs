...
#[doc = "Field `IPRIOR28` reader - RW,IPRIOR28"]
pub type Iprior28R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR28` writer - RW,IPRIOR28"]
pub type Iprior28W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR28"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR28"]
    #[inline(always)]
    pub fn iprior28(&mut self) -> Iprior28W<'_, R32PficIprior28Spec> {
