...
#[doc = "Field `IPRIOR24` reader - RW,IPRIOR24"]
pub type Iprior24R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR24` writer - RW,IPRIOR24"]
pub type Iprior24W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR24"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR24"]
    #[inline(always)]
    pub fn iprior24(&mut self) -> Iprior24W<'_, R32PficIprior24Spec> {
