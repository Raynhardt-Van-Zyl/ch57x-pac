...
#[doc = "Field `IPRIOR21` reader - RW,IPRIOR21"]
pub type Iprior21R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR21` writer - RW,IPRIOR21"]
pub type Iprior21W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR21"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR21"]
    #[inline(always)]
    pub fn iprior21(&mut self) -> Iprior21W<'_, R32PficIprior21Spec> {
