...
#[doc = "Field `IPRIOR19` reader - RW,IPRIOR19"]
pub type Iprior19R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR19` writer - RW,IPRIOR19"]
pub type Iprior19W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR19"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR19"]
    #[inline(always)]
    pub fn iprior19(&mut self) -> Iprior19W<'_, R32PficIprior19Spec> {
