...
#[doc = "Field `IPRIOR54` reader - RW,IPRIOR54"]
pub type Iprior54R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR54` writer - RW,IPRIOR54"]
pub type Iprior54W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR54"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR54"]
    #[inline(always)]
    pub fn iprior54(&mut self) -> Iprior54W<'_, R32PficIprior54Spec> {
