...
#[doc = "Field `IPRIOR17` reader - RW,IPRIOR17"]
pub type Iprior17R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR17` writer - RW,IPRIOR17"]
pub type Iprior17W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR17"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR17"]
    #[inline(always)]
    pub fn iprior17(&mut self) -> Iprior17W<'_, R32PficIprior17Spec> {
