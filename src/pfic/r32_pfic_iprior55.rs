...
#[doc = "Field `IPRIOR55` reader - RW,IPRIOR55"]
pub type Iprior55R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR55` writer - RW,IPRIOR55"]
pub type Iprior55W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR55"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR55"]
    #[inline(always)]
    pub fn iprior55(&mut self) -> Iprior55W<'_, R32PficIprior55Spec> {
