...
#[doc = "Field `IPRIOR52` reader - RW,IPRIOR52"]
pub type Iprior52R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR52` writer - RW,IPRIOR52"]
pub type Iprior52W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR52"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR52"]
    #[inline(always)]
    pub fn iprior52(&mut self) -> Iprior52W<'_, R32PficIprior52Spec> {
