...
#[doc = "Field `IPRIOR59` reader - RW,IPRIOR59"]
pub type Iprior59R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR59` writer - RW,IPRIOR59"]
pub type Iprior59W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR59"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR59"]
    #[inline(always)]
    pub fn iprior59(&mut self) -> Iprior59W<'_, R32PficIprior59Spec> {
