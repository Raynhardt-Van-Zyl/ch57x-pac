...
#[doc = "Field `IPRIOR18` reader - RW,IPRIOR18"]
pub type Iprior18R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR18` writer - RW,IPRIOR18"]
pub type Iprior18W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR18"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR18"]
    #[inline(always)]
    pub fn iprior18(&mut self) -> Iprior18W<'_, R32PficIprior18Spec> {
