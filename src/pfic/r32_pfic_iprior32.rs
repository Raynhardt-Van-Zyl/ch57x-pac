...
#[doc = "Field `IPRIOR32` reader - RW,IPRIOR32"]
pub type Iprior32R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR32` writer - RW,IPRIOR32"]
pub type Iprior32W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR32"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR32"]
    #[inline(always)]
    pub fn iprior32(&mut self) -> Iprior32W<'_, R32PficIprior32Spec> {
