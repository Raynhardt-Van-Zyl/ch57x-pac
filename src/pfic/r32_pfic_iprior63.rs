...
#[doc = "Field `IPRIOR63` reader - RW,IPRIOR63"]
pub type Iprior63R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR63` writer - RW,IPRIOR63"]
pub type Iprior63W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR63"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR63"]
    #[inline(always)]
    pub fn iprior63(&mut self) -> Iprior63W<'_, R32PficIprior63Spec> {
