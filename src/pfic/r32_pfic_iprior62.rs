...
#[doc = "Field `IPRIOR62` reader - RW,IPRIOR62"]
pub type Iprior62R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR62` writer - RW,IPRIOR62"]
pub type Iprior62W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR62"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR62"]
    #[inline(always)]
    pub fn iprior62(&mut self) -> Iprior62W<'_, R32PficIprior62Spec> {
