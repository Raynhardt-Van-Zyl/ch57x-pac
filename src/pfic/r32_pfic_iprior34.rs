...
#[doc = "Field `IPRIOR34` reader - RW,IPRIOR34"]
pub type Iprior34R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR34` writer - RW,IPRIOR34"]
pub type Iprior34W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR34"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR34"]
    #[inline(always)]
    pub fn iprior34(&mut self) -> Iprior34W<'_, R32PficIprior34Spec> {
