...
#[doc = "Field `IPRIOR51` reader - RW,IPRIOR51"]
pub type Iprior51R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR51` writer - RW,IPRIOR51"]
pub type Iprior51W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR51"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR51"]
    #[inline(always)]
    pub fn iprior51(&mut self) -> Iprior51W<'_, R32PficIprior51Spec> {
