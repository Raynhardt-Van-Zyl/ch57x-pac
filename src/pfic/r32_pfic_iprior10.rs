...
#[doc = "Field `IPRIOR10` reader - >RW,IPRIOR10"]
pub type Iprior10R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR10` writer - >RW,IPRIOR10"]
pub type Iprior10W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - >RW,IPRIOR10"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - >RW,IPRIOR10"]
    #[inline(always)]
    pub fn iprior10(&mut self) -> Iprior10W<'_, R32PficIprior10Spec> {
