...
#[doc = "Field `IPRIOR42` reader - RW,IPRIOR42"]
pub type Iprior42R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR42` writer - RW,IPRIOR42"]
pub type Iprior42W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR42"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR42"]
    #[inline(always)]
    pub fn iprior42(&mut self) -> Iprior42W<'_, R32PficIprior42Spec> {
