...
#[doc = "Field `IPRIOR47` reader - RW,IPRIOR47"]
pub type Iprior47R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR47` writer - RW,IPRIOR47"]
pub type Iprior47W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR47"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR47"]
    #[inline(always)]
    pub fn iprior47(&mut self) -> Iprior47W<'_, R32PficIprior47Spec> {
