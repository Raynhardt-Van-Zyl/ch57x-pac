...
#[doc = "Field `IPRIOR38` reader - RW,IPRIOR38"]
pub type Iprior38R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR38` writer - RW,IPRIOR38"]
pub type Iprior38W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR38"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR38"]
    #[inline(always)]
    pub fn iprior38(&mut self) -> Iprior38W<'_, R32PficIprior38Spec> {
