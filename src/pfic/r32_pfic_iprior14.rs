...
#[doc = "Field `IPRIOR14` reader - RW,IPRIOR14"]
pub type Iprior14R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR14` writer - RW,IPRIOR14"]
pub type Iprior14W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR14"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR14"]
    #[inline(always)]
    pub fn iprior14(&mut self) -> Iprior14W<'_, R32PficIprior14Spec> {
