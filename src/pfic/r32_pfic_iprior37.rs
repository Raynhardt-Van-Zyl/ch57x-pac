...
#[doc = "Field `IPRIOR37` reader - RW,IPRIOR37"]
pub type Iprior37R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR37` writer - RW,IPRIOR37"]
pub type Iprior37W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR37"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR37"]
    #[inline(always)]
    pub fn iprior37(&mut self) -> Iprior37W<'_, R32PficIprior37Spec> {
