...
#[doc = "Field `IPRIOR53` reader - RW,IPRIOR53"]
pub type Iprior53R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR53` writer - RW,IPRIOR53"]
pub type Iprior53W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR53"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR53"]
    #[inline(always)]
    pub fn iprior53(&mut self) -> Iprior53W<'_, R32PficIprior53Spec> {
