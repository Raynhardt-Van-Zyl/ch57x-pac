...
#[doc = "Field `IPRIOR45` reader - RW,IPRIOR45"]
pub type Iprior45R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR45` writer - RW,IPRIOR45"]
pub type Iprior45W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR45"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR45"]
    #[inline(always)]
    pub fn iprior45(&mut self) -> Iprior45W<'_, R32PficIprior45Spec> {
