...
#[doc = "Field `IPRIOR56` reader - RW,IPRIOR56"]
pub type Iprior56R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR56` writer - RW,IPRIOR56"]
pub type Iprior56W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR56"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR56"]
    #[inline(always)]
    pub fn iprior56(&mut self) -> Iprior56W<'_, R32PficIprior56Spec> {
