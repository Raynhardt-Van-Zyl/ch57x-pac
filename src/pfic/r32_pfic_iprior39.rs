...
#[doc = "Field `IPRIOR39` reader - RW,IPRIOR39"]
pub type Iprior39R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR39` writer - RW,IPRIOR39"]
pub type Iprior39W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR39"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR39"]
    #[inline(always)]
    pub fn iprior39(&mut self) -> Iprior39W<'_, R32PficIprior39Spec> {
