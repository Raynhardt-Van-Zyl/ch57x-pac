...
#[doc = "Field `IPRIOR41` reader - RW,IPRIOR41"]
pub type Iprior41R = crate::FieldReader<u32>;
#[doc = "Field `IPRIOR41` writer - RW,IPRIOR41"]
pub type Iprior41W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - RW,IPRIOR41"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - RW,IPRIOR41"]
    #[inline(always)]
    pub fn iprior41(&mut self) -> Iprior41W<'_, R32PficIprior41Spec> {
