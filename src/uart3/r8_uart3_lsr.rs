#[doc = "Register `R8_UART3_LSR` reader"]
pub type R = crate::R<R8Uart3LsrSpec>;
...
#[doc = "RO, UART3 line status\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart3_lsr::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Uart3LsrSpec;
impl crate::RegisterSpec for R8Uart3LsrSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_uart3_lsr::R`](R) reader structure"]
impl crate::Readable for R8Uart3LsrSpec {}
#[doc = "`reset()` method sets R8_UART3_LSR to value 0x60"]
impl crate::Resettable for R8Uart3LsrSpec {
