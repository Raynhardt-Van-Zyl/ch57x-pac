#[doc = "Register `R8_UART3_IER` reader"]
pub type R = crate::R<R8Uart3IerSpec>;
#[doc = "Register `R8_UART3_IER` writer"]
pub type W = crate::W<R8Uart3IerSpec>;
...
impl W {
    #[doc = "Bit 0 - RW, UART interrupt enable for receiver data ready"]
    #[inline(always)]
    pub fn rb_ier_recv_rdy(&mut self) -> RbIerRecvRdyW<'_, R8Uart3IerSpec> {
        RbIerRecvRdyW::new(self, 0)
    }
    #[doc = "Bit 1 - RW, UART interrupt enable for THR empty"]
    #[inline(always)]
    pub fn rb_ier_thr_empty(&mut self) -> RbIerThrEmptyW<'_, R8Uart3IerSpec> {
        RbIerThrEmptyW::new(self, 1)
    }
    #[doc = "Bit 2 - RW, UART interrupt enable for receiver line status"]
    #[inline(always)]
    pub fn rb_ier_line_stat(&mut self) -> RbIerLineStatW<'_, R8Uart3IerSpec> {
        RbIerLineStatW::new(self, 2)
    }
    #[doc = "Bit 6 - RW, UART TXD pin enable"]
    #[inline(always)]
    pub fn rb_ier_txd_en(&mut self) -> RbIerTxdEnW<'_, R8Uart3IerSpec> {
        RbIerTxdEnW::new(self, 6)
    }
    #[doc = "Bit 7 - WZ, UART software reset control, high action, auto clear"]
    #[inline(always)]
    pub fn rb_ier_reset(&mut self) -> RbIerResetW<'_, R8Uart3IerSpec> {
        RbIerResetW::new(self, 7)
    }
}
#[doc = "RW, UART3 interrupt enable\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart3_ier::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_uart3_ier::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Uart3IerSpec;
impl crate::RegisterSpec for R8Uart3IerSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_uart3_ier::R`](R) reader structure"]
impl crate::Readable for R8Uart3IerSpec {}
#[doc = "`write(|w| ..)` method takes [`r8_uart3_ier::W`](W) writer structure"]
impl crate::Writable for R8Uart3IerSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets R8_UART3_IER to value 0"]
impl crate::Resettable for R8Uart3IerSpec {}
