...
#[doc = "Field `R8_UART3_DIV` reader - RW, UART3 pre-divisor latch byte, only low 7 bit, from 1 to 128"]
pub type R8Uart3DivR = crate::FieldReader;
#[doc = "Field `R8_UART3_DIV` writer - RW, UART3 pre-divisor latch byte, only low 7 bit, from 1 to 128"]
