...
pub type R = crate::R<R8Uart3IirSpec>;
...
#[doc = "RO, UART3 interrupt identification\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart3_iir::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Uart3IirSpec;
impl crate::RegisterSpec for R8Uart3IirSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_uart3_iir::R`](R) reader structure"]
impl crate::Readable for R8Uart3IirSpec {}
#[doc = "`reset()` method sets R8_UART3_IIR to value 0x01"]
impl crate::Resettable for R8Uart3IirSpec {
