...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn r8_uart1_thr(&self) -> &R8Uart1Thr {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(8).cast() }
    }
    #[doc = "0x08 - RO, UART1 receiver buffer, receiving byte"]
    #[inline(always)]
    pub const fn r8_uart1_rbr(&self) -> &R8Uart1Rbr {
        unsafe { &*core::ptr::from_ref(self).cast::<u8>().add(8).cast() }
    }
...
#[doc = "R8_UART1_RBR (r) register accessor: RO, UART1 receiver buffer, receiving byte\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart1_rbr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@r8_uart1_rbr`] module"]
#[doc(alias = "R8_UART1_RBR")]
pub type R8Uart1Rbr = crate::Reg<r8_uart1_rbr::R8Uart1RbrSpec>;
#[doc = "RO, UART1 receiver buffer, receiving byte"]
pub mod r8_uart1_rbr;
#[doc = "R8_UART1_THR (w) register accessor: WO, UART1 transmitter holding, transmittal byte\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_uart1_thr::W`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@r8_uart1_thr`] module"]
#[doc(alias = "R8_UART1_THR")]
pub type R8Uart1Thr = crate::Reg<r8_uart1_thr::R8Uart1ThrSpec>;
#[doc = "WO, UART1 transmitter holding, transmittal byte"]
pub mod r8_uart1_thr;
#[doc = "R8_UART1_RFC (r) register accessor: RO, UART1 receiver FIFO count\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_uart1_rfc::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@r8_uart1_rfc`] module"]
