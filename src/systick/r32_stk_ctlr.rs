...
impl W {
    #[doc = "Bit 0 - Systick counter enable"]
    #[inline(always)]
    pub fn ste(&mut self) -> SteW<'_, R32StkCtlrSpec> {
        SteW::new(self, 0)
    }
    #[doc = "Bit 1 - Systick counter interrupt enable"]
    #[inline(always)]
    pub fn stie(&mut self) -> StieW<'_, R32StkCtlrSpec> {
        StieW::new(self, 1)
    }
    #[doc = "Bit 2 - System counter clock Source selection"]
    #[inline(always)]
    pub fn stclk(&mut self) -> StclkW<'_, R32StkCtlrSpec> {
        StclkW::new(self, 2)
    }
    #[doc = "Bit 8 - System counter reload control"]
    #[inline(always)]
    pub fn streload(&mut self) -> StreloadW<'_, R32StkCtlrSpec> {
