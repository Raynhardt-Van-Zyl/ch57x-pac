...
#[doc = "Field `R8_WDOG_COUNT` reader - RF,watch-dog count, count by clock frequency Fsys/131072"]
pub type R8WdogCountR = crate::FieldReader;
#[doc = "Field `R8_WDOG_COUNT` writer - RF,watch-dog count, count by clock frequency Fsys/131072"]
