...
#[doc = "Field `RB_SLP_CLK_TMR0` reader - RWA, close TMR0 clock"]
pub type RbSlpClkTmr0R = crate::BitReader;
#[doc = "Field `RB_SLP_CLK_TMR0` writer - RWA, close TMR0 clock"]
pub type RbSlpClkTmr0W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RB_SLP_CLK_TMR1` reader - RWA, close TMR1 clock"]
pub type RbSlpClkTmr1R = crate::BitReader;
#[doc = "Field `RB_SLP_CLK_TMR1` writer - RWA, close TMR1 clock"]
pub type RbSlpClkTmr1W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RB_SLP_CLK_TMR2` reader - RWA, close TMR2 clock"]
pub type RbSlpClkTmr2R = crate::BitReader;
#[doc = "Field `RB_SLP_CLK_TMR2` writer - RWA, close TMR2 clock"]
pub type RbSlpClkTmr2W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RB_SLP_CLK_TMR3` reader - RWA, close TMR3 clock"]
pub type RbSlpClkTmr3R = crate::BitReader;
#[doc = "Field `RB_SLP_CLK_TMR3` writer - RWA, close TMR3 clock"]
pub type RbSlpClkTmr3W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RB_SLP_CLK_UART0` reader - RWA, close UART0 clock"]
pub type RbSlpClkUart0R = crate::BitReader;
#[doc = "Field `RB_SLP_CLK_UART0` writer - RWA, close UART0 clock"]
pub type RbSlpClkUart0W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RB_SLP_CLK_UART1` reader - RWA, close UART1 clock"]
pub type RbSlpClkUart1R = crate::BitReader;
#[doc = "Field `RB_SLP_CLK_UART1` writer - RWA, close UART1 clock"]
pub type RbSlpClkUart1W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RB_SLP_CLK_UART2` reader - RWA, close UART2 clock"]
pub type RbSlpClkUart2R = crate::BitReader;
#[doc = "Field `RB_SLP_CLK_UART2` writer - RWA, close UART2 clock"]
pub type RbSlpClkUart2W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RB_SLP_CLK_UART3` reader - RWA, close UART3 clock"]
pub type RbSlpClkUart3R = crate::BitReader;
#[doc = "Field `RB_SLP_CLK_UART3` writer - RWA, close UART3 clock"]
...
impl R {
    ...
    #[inline(always)]
    pub fn rb_slp_clk_tmr3(&self) -> RbSlpClkTmr3R {
        RbSlpClkTmr3R::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 3 - RWA, close TMR3 clock"]
    #[inline(always)]
    pub fn rb_slp_clk_tmr3(&mut self) -> RbSlpClkTmr3W<'_, R8SlpClkOff0Spec> {
        RbSlpClkTmr3W::new(self, 3)
    }
    #[doc = "Bit 4 - RWA, close UART0 clock"]
    #[inline(always)]
