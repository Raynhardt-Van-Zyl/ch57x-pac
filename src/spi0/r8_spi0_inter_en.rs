...
pub type R = crate::R<R8Spi0InterEnSpec>;
#[doc = "Register `R8_SPI0_INTER_EN` writer"]
pub type W = crate::W<R8Spi0InterEnSpec>;
...
impl W {
    #[doc = "Bit 0 - RW, enable interrupt for SPI total byte count end"]
    #[inline(always)]
    pub fn rb_spi_ie_cnt_end(&mut self) -> RbSpiIeCntEndW<'_, R8Spi0InterEnSpec> {
        RbSpiIeCntEndW::new(self, 0)
    }
    #[doc = "Bit 1 - RW, enable interrupt for SPI byte exchanged"]
    #[inline(always)]
    pub fn rb_spi_ie_byte_end(&mut self) -> RbSpiIeByteEndW<'_, R8Spi0InterEnSpec> {
        RbSpiIeByteEndW::new(self, 1)
    }
    #[doc = "Bit 2 - RW, enable interrupt for SPI FIFO half"]
    #[inline(always)]
    pub fn rb_spi_ie_fifo_hf(&mut self) -> RbSpiIeFifoHfW<'_, R8Spi0InterEnSpec> {
        RbSpiIeFifoHfW::new(self, 2)
    }
    #[doc = "Bit 3 - RW, enable interrupt for SPI0 DMA completion"]
    #[inline(always)]
    pub fn rb_spi_ie_dma_end(&mut self) -> RbSpiIeDmaEndW<'_, R8Spi0InterEnSpec> {
        RbSpiIeDmaEndW::new(self, 3)
    }
    #[doc = "Bit 4 - RW, enable interrupt for SPI0 FIFO overflow"]
    #[inline(always)]
    pub fn rb_spi_ie_fifo_ov(&mut self) -> RbSpiIeFifoOvW<'_, R8Spi0InterEnSpec> {
        RbSpiIeFifoOvW::new(self, 4)
    }
    #[doc = "Bit 7 - RW, enable interrupt for SPI0 slave mode first byte received"]
    #[inline(always)]
    pub fn rb_spi_ie_fst_byte(&mut self) -> RbSpiIeFstByteW<'_, R8Spi0InterEnSpec> {
        RbSpiIeFstByteW::new(self, 7)
    }
}
#[doc = "RW, SPI0 interrupt enable\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_spi0_inter_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_spi0_inter_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Spi0InterEnSpec;
impl crate::RegisterSpec for R8Spi0InterEnSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_spi0_inter_en::R`](R) reader structure"]
impl crate::Readable for R8Spi0InterEnSpec {}
#[doc = "`write(|w| ..)` method takes [`r8_spi0_inter_en::W`](W) writer structure"]
impl crate::Writable for R8Spi0InterEnSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets R8_SPI0_INTER_EN to value 0"]
impl crate::Resettable for R8Spi0InterEnSpec {}
