...
#[doc = "Field `R16_SPI0_TOTAL_CNT` reader - RW, SPI0 total byte count, only low 12 bit"]
pub type R16Spi0TotalCntR = crate::FieldReader<u16>;
#[doc = "Field `R16_SPI0_TOTAL_CNT` writer - RW, SPI0 total byte count, only low 12 bit"]
