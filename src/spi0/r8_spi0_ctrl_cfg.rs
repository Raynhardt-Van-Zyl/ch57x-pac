...
pub type R = crate::R<R8Spi0CtrlCfgSpec>;
#[doc = "Register `R8_SPI0_CTRL_CFG` writer"]
pub type W = crate::W<R8Spi0CtrlCfgSpec>;
...
impl W {
    #[doc = "Bit 0 - RW, SPI0 DMA enable"]
    #[inline(always)]
    pub fn rb_spi_dma_enable(&mut self) -> RbSpiDmaEnableW<'_, R8Spi0CtrlCfgSpec> {
        RbSpiDmaEnableW::new(self, 0)
    }
    #[doc = "Bit 2 - RW, SPI0 DMA address loop enable"]
    #[inline(always)]
    pub fn rb_spi_dma_loop(&mut self) -> RbSpiDmaLoopW<'_, R8Spi0CtrlCfgSpec> {
        RbSpiDmaLoopW::new(self, 2)
    }
    #[doc = "Bit 4 - RW, enable buffer/FIFO accessing to auto clear RB_SPI_IF_BYTE_END interrupt flag"]
    #[inline(always)]
    pub fn rb_spi_auto_if(&mut self) -> RbSpiAutoIfW<'_, R8Spi0CtrlCfgSpec> {
        RbSpiAutoIfW::new(self, 4)
    }
    #[doc = "Bit 5 - RW, SPI bit data order: 0=MSB first, 1=LSB first"]
    #[inline(always)]
    pub fn rb_spi_bit_order(&mut self) -> RbSpiBitOrderW<'_, R8Spi0CtrlCfgSpec> {
        RbSpiBitOrderW::new(self, 5)
    }
    #[doc = "Bit 6 - RW, SPI master input delay enable"]
    #[inline(always)]
    pub fn rb_spi_mst_dly_en(&mut self) -> RbSpiMstDlyEnW<'_, R8Spi0CtrlCfgSpec> {
        RbSpiMstDlyEnW::new(self, 6)
    }
}
#[doc = "RW, SPI0 configuration control\n\nYou can [`read`](crate::Reg::read) this register and get [`r8_spi0_ctrl_cfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`r8_spi0_ctrl_cfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct R8Spi0CtrlCfgSpec;
impl crate::RegisterSpec for R8Spi0CtrlCfgSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`r8_spi0_ctrl_cfg::R`](R) reader structure"]
impl crate::Readable for R8Spi0CtrlCfgSpec {}
#[doc = "`write(|w| ..)` method takes [`r8_spi0_ctrl_cfg::W`](W) writer structure"]
impl crate::Writable for R8Spi0CtrlCfgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets R8_SPI0_CTRL_CFG to value 0"]
impl crate::Resettable for R8Spi0CtrlCfgSpec {}
