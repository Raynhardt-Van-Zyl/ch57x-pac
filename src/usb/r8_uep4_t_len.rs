...
#[doc = "Field `R8_UEP4_T_LEN` reader - endpoint 4transmittal length"]
pub type R8Uep4TLenR = crate::FieldReader;
#[doc = "Field `R8_UEP4_T_LEN` writer - endpoint 4transmittal length"]
pub type R8Uep4TLenW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - endpoint 4transmittal length"]
    #[inline(always)]
    pub fn r8_uep4_t_len(&self) -> R8Uep4TLenR {
        R8Uep4TLenR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:7 - endpoint 4transmittal length"]
    #[inline(always)]
    pub fn r8_uep4_t_len(&mut self) -> R8Uep4TLenW<'_, R8Uep4TLenSpec> {
